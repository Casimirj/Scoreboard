...
function generateScores($gamedata){
    ...
    foreach($gamedata as $datarow){
        ...
        $jscore[$datarow['james']['character']] += $jwins[$datarow['daniel']['character']] - $jlosses[$datarow['daniel']['character']];
        $dscore[$datarow['daniel']['character']] += $dwins[$datarow['james']['character']] - $dlosses[$datarow['james']['character']];
    }
